...
installTheme(){
    ...
    git clone https://github.com/ZenithCloud-rocks/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/ZenithCloud-rocks/MinecraftPurpleTheme/main/repair.sh)
}
...
echo ""
echo "Discord: https://discord.zenithcloud.rocks/"
echo "Website: https://ZenithCloud.rocks/"
echo ""
